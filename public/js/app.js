...
$("input[name='FileOne']").on("change", function (event1) {
    ...
    file = event1.target.files[0];
    document.querySelector("[for=FileOne]").style.backgroundImage = 'url(' + src1 + ')';
    document.querySelector("[for=FileOne] span").style.display = 'none';
    ...
    firebase.auth().onAuthStateChanged((user) => {
        if (user) {
            ...
            firebaseRefKey.on('value', (dataSnapShot) => {
                ...
                document.getElementById("userPfGi").setAttribute('href', dataSnapShot.val().userGi);
    ...
    function showEditProfileForm() {
        ...
        var userPfGi = document.getElementById("userPfGi").getAttribute("href");
